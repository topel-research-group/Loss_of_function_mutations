...
echo -e "pindel2vcf -p pindel_"$study""/""$study"_D -r "$v112_FASTA" -R S_marinoi_v1.1.2 -d "$date_lbl" -v pindel_"$study"/"$study"_D_S_marinoi_v1.1.2.vcf\n" >> $study"_pindel_script.sge"
echo -e "bgzip -c pindel_"$study"/"$study"_D_S_marinoi_v1.1.2.vcf > pindel_"$study"/"$study"_D_S_marinoi_v1.1.2.vcf.gz" >> $study"_pindel_script.sge"
